...
return(
    ...
    <td width="25%"className={styles.th}>Patrimonio</td>
    <td width="25%" className={styles.th}>Equipamento</td>
    <td width="25%" className={styles.th}>Marca</td>
    <td width="25%" className={styles.th}>Modelo</td>
    <td width="25%" className={styles.th}>Nsérie</td>
    <td width="25%" className={styles.th}>Localização</td>
    </th></tr>
    </table>
